...
import jenkins.local.model.builds.BuildHistoryPage;
import jenkins.local.model.jobs.details.FolderDetailsPage;
import jenkins.local.model.nodes.NodeCreatePage;
import jenkins.local.model.nodes.NodeDetailsPage;
import jenkins.local.model.nodes.NodesListPage;
import jenkins.local.model.view.MyViewsPage;
import jenkins.local.model.view.NewViewPageFromDashboard;
